...
void GazeboQuadrotorStateController::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
  ...
  // camera image data
  std::string cam_out_topic  = "/" + drone_name + "/image_raw";
  std::string cam_front_in_topic = "/" + drone_name + "/front/image_raw";
  std::string cam_bottom_in_topic = "/" + drone_name + "/bottom/image_raw";
  ...
  // camera image data
  std::string cam_info_out_topic  = "/" + drone_name + "/camera_info";
  std::string cam_info_front_in_topic = "/" + drone_name + "/front/camera_info";
  std::string cam_info_bottom_in_topic = "/" + drone_name + "/bottom/camera_info";
